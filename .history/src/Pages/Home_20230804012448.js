  ...
  return (
    <Fragment>
      ...
      <div className='banner'>
            <div className='container d-flex justify-content-between align-items-center flex-wrap my-5'>
            <div className='detail ol-md-6 col-lg-6  col-sm-12 align-items-center'>
