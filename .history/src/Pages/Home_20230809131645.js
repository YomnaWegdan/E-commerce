...
const Home = () => {
  const { detail , View , close , setClose , addToCart} = useAppContext();
...

    {
      ...
      <div className='container'>
        ...
        <div className='product_type w-100  '>
          ...
          <div className='product container col-lg-3 col-md-6 col-sm-12  w-auto  col-lg-3 col-md-6 col-sm-12  w-auto'>
          <h2 className=' w-auto mx-auto mt-3 mb-5'>Top Products</h2>
          <div className='container col-lg-3 col-md-6 col-sm-12  w-auto  col-lg-3 col-md-6 col-sm-12  w-auto'>
            {Homeproduct.map((el)=>{
              return(
                <div className='box ' key={el.id}>
                <div className='img_box d-flex justify-content-around col-lg-3 col-md-6 col-sm-12  w-auto'>
                <img src={el.Img} alt={el.Title}></img>
                <div className='icon'>
