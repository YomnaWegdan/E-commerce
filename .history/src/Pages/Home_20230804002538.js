  ...
  return (
    <Fragment>
        ...
        <div className='product_type w-100  '>
          ...
          <h2>Top Products</h2>
          <div className='container d-flex justify-content-around flex-wrap col-lg-3 col-md-6 col-sm-12 d-flex justify-content-around flex-wrap col-lg-3 col-md-6 col-sm-12  w-auto'>
            {Homeproduct.map((el)=>{
              return(
