  ...
  return (
    <Fragment>
        ...
        <div className='product_type w-100  '>
          ...
          <h2>Top Products</h2>
          <div className='container d-flex justify-content-around flex-wrap align-items-center col-lg-3 col-md-6 col-sm-12  w-auto'>
            {Homeproduct.map((el)=>{
              return(
              ...
              <div className='detail w-auto  col-lg-3'>
              <p> {el.Cat}</p>
              <h4 className=''>{el.Title}</h4>
              <h5 style={{color:'#0989ff'}}>{el.Price}</h5>
              </div>
                </div>
              )
